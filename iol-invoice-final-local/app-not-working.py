...
def invoice():
    ...
    try:
        if request.method == 'POST':
            ...
            #f= open(app.config['UPLOAD_FOLDER'] + "/" + name + ".txt","w")
            #f.write('<html><body>\n<table border="0" cellspacing="5" cellpadding="5" width="100%">\n<tr>\n<td style="vertical-align: top;" width="50%">\n<img src="cisco-logo.png" alt="Logo">\n</td>\n<td style="vertical-align: top; text-align:right;" width="50%">\n<span style="text-align:right;">Businessname</span><br />\n<span style="text-align:right;">Email</span>\n</td>\n</tr>\n</table>\n</body>\n</html>')
            
            
            #f.close()
            
            return render_template('invoice-html.html', user=current_user, invoice_data=found_invoice_data, items_data=found_invoice_items, invoice_values=found_invoice_values, profile_data=found_profile_data, image_data=found_image_data)   

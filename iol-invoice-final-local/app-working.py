...
def invoice():
    ...
    try:
        if request.method == 'POST':
            ...
            left: 50pt; width: 512pt; top: 10pt; height: 632pt; \
            } \
           @frame footer_frame {           /* Another static Frame */ \
            ...
            <table border='0' cellspacing='5' cellpadding='5' width='100%' style='margin-top: 20px;'> \
            <tr> \
            <td style='width=50%'> \
            ...
            f=open("uploads/" + name + ".html","a")
            f.write("</table> \
            <div id='footer_content' style='text-align: center;'>page <pdf:pagenumber> \
            of <pdf:pagecount> \
            </div> \
            </body> \
            </html>")
